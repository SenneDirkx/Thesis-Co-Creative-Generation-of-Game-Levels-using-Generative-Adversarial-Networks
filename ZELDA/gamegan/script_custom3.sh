#!/bin/zsh
python interact.py ./ZeldaDungeon02_5000_10Z.pth 10 4 11 16 56 6,4,9,6 51,16 6,4,9,6,6,4,9,6 10000 10000 1024 latent_input.txt edited_output3.json 3 ./output_custom_local/rewritten_custom_generator3.pth 1 0.0001
