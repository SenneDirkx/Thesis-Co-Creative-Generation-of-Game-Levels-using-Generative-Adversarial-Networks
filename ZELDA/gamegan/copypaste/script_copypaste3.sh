#!/bin/zsh
python interact_copypaste.py ../ZeldaDungeon02_5000_10Z.pth 10 4 11 16 53 2,2,6,8 4 9,2,13,8 7,16,17,26,55 9,2,13,8,9,2,13,8,9,2,13,8,9,2,13,8,9,2,13,8 3000 512 latent_input.txt 3 ./output/rewritten_cp_generator3_normal.pth 16 0.001
cd ..
