#!/bin/zsh
python interact.py ./ZeldaDungeon02_5000_10Z.pth 10 4 11 16 5 2,1,6,4 7,40,46,30 2,1,6,4,2,1,6,4,2,1,6,4,2,1,6,4 10000 10000 1024 latent_input.txt edited_output4.json 3 ./output_custom_local/rewritten_custom_generator4.pth 1 0.0001
