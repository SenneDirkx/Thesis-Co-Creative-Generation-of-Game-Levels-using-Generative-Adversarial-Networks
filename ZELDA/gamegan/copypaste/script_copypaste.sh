#!/bin/zsh
python interact_copypaste.py ../ZeldaDungeon02_5000_10Z.pth 10 4 11 16 6 3,3,6,6 10 6,3,10,7 11,12,18,27 6,3,10,7,6,3,10,7,6,3,10,7,6,3,10,7 5000 1024 latent_input.txt 3 ./output/rewritten_cp_generator_normal.pth 1 0.0001
cd ..
