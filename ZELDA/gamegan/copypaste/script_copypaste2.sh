#!/bin/zsh
python interact_copypaste.py ../ZeldaDungeon02_5000_10Z.pth 10 4 11 16 58 2,2,5,8 6 10,2,13,8 46,55,6,63 10,2,13,8,10,2,13,8,10,2,13,8,10,2,13,8 5000 1024 latent_input.txt 3 ./output/rewritten_cp_generator2_normal.pth 1 0.0001
cd ..
