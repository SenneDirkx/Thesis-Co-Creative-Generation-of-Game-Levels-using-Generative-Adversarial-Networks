#!/bin/zsh
python interact_copypaste.py ../ZeldaDungeon02_5000_10Z.pth 10 4 11 16 62 5,4,6,5 18 6,3,10,7 10,11,12,54 6,3,10,7,6,3,10,7,6,3,10,7,6,3,10,7 2500 1024 latent_input.txt 3 ./output/rewritten_cp_generator5_normal.pth 8 0.001
cd ..
